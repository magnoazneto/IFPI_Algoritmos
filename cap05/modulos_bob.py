...
def koch(t, comprimento):  # DESENHAR LINHAS DE KOCH
	if comprimento >= 3:
		koch(t, comprimento//3)
		t.left(60)
		koch(t, comprimento//3)
		t.right(120)
		koch(t, comprimento//3)
...
def snowflake(t, comprimento):  # DESENHAR UM FRACTAL DE GELO
	for c in range(3):
		koch(t, comprimento)
		t.right(120)


def demo_koch(t, comprimento):  # ESTRELA COM LINHAS DE KOCH
	for c in range(3):
		t.fd(comprimento//3)
		t.left(60)
		t.fd(comprimento//3)
